export interface SupplyChainNodeType {
  type:string
  label:string
  color:string
}

export const NODE_TYPES:Array<SupplyChainNodeType> = [
...
export function resolveNodeType(type:string) {
    return NODE_TYPES.find(t => t.type === type)
}

const DEFAULT_COLOR = "#445566"

export function resolveNodeColor(type:string) {
